...
BEGIN
    DECLARE v_nueva_id_producto INT;
    ...
    SET v_nueva_id_producto = LAST_INSERT_ID();
    ...
    IF EXISTS (
        ...
        IF p_caracteristicas IS NOT NULL AND JSON_LENGTH(p_caracteristicas) > 0 THEN
            SET @sql = CONCAT('INSERT INTO ', v_nombre_tabla_caracteristicas, ' SET id_producto = ', v_nueva_id_producto);
        ...
        ELSE
            SET @sql = CONCAT('INSERT INTO ', v_nombre_tabla_caracteristicas, ' (id_producto) VALUES (', v_nueva_id_producto, ')');
            PREPARE stmt FROM @sql;
            EXECUTE stmt;
            DEALLOCATE PREPARE stmt;
        END IF;
