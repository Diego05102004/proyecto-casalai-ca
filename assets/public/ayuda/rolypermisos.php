    ...
    <div class="modal-ayuda-container">
        ...
        <div class="modal-ayuda-content">
            ...
            <div class="ayuda-seccion" id="ayudaPrincipal">
                ...
                <p class="ayuda-descripcion">Defina los roles y permisos para controlar el acceso al sistema.</p>
            ...
            <div class="ayuda-tarjetas" id="ayudaTarjetas" style="display: none;">
                ...
                <div class="tarjeta-ayuda tarjeta-registrar" data-tarjeta="registrar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite crear un nuevo rol en el sistema con su configuración inicial.</p>
                        <ul>
                            <li>Haga clic en el botón "+" (color verde) para nuevo rol</li>
                            <li>Ingrese el nombre del rol</li>
                ...
                <div class="tarjeta-ayuda tarjeta-modificar" data-tarjeta="modificar" style="display: none;">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite actualizar los datos de un rol existente en el sistema.</p>
                        <ul>
                            <li>Localice el rol en la tabla</li>
                ...
                <div class="tarjeta-ayuda tarjeta-estatus" data-tarjeta="estatus" style="display: none;">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite configurar los permisos específicos que tendrá un rol en cada módulo del sistema.</p>
                        <ul>
                            <li>Haga clic en el botón "Gestionar Permisos" (color verde) del rol a configurar</li>
                            <li>Seleccione qué acciones podrá realizar el usuario en cada módulo</li>
                            <li>Configure acceso: ingresar, consultar, incluir, modificar, eliminar, generar reporte</li>
                            <li>Haga clic en "Guardar Permisos" para confirmar</li>
                            <li>Los permisos se aplican inmediatamente a los usuarios con ese rol</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="tarjeta-ayuda tarjeta-eliminar" data-tarjeta="eliminar" style="display: none;">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite remover permanentemente un rol del sistema.</p>
                        <ul>
                            <li>Encuentre el rol que desea eliminar</li>
