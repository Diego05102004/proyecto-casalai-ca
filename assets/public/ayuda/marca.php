            ...
            <div class="ayuda-seccion" id="ayudaPrincipal">
                <div class="ayuda-header">
                    <div class="ayuda-icon">
                        <i class="bi bi-tag me-2 fs-1"></i>
                    </div>
                    <h3 class="ayuda-titulo">Gestión de Marcas</h3>
                </div>
                
                <p class="ayuda-descripcion">Administre las marcas de productos para organizar mejor el inventario.</p>
            ...
            <div class="ayuda-tarjetas" id="ayudaTarjetas" style="display: none;">
                ...
                <div class="tarjeta-ayuda tarjeta-registrar" data-tarjeta="registrar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite registrar una nueva marca de productos en el sistema.</p>
                        <ul>
                            <li>Haga clic en el botón "+" (color verde) para nueva marca</li>
                            <li>Ingrese el nombre de la marca</li>
                            <li>Haga clic en "Registrar" para confirmar</li>
                        </ul>
                        <div class="alert alert-info">
                            <strong>Importante:</strong> El nombre de la marca debe ser único en el sistema
                        </div>
                    </div>
                </div>
                ...
                <div class="tarjeta-ayuda tarjeta-modificar" data-tarjeta="modificar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite actualizar los datos de una marca existente.</p>
                        <ul>
                            <li>Localice la marca en la tabla</li>
                ...
                <div class="tarjeta-ayuda tarjeta-eliminar" data-tarjeta="eliminar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite remover una marca del sistema.</p>
                        <ul>
                            <li>Encuentre la marca que desea eliminar</li>
