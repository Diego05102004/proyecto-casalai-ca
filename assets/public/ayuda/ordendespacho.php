    ...
    <div class="modal-ayuda-container">
        ...
        <div class="modal-ayuda-content">
            ...
            <div class="ayuda-seccion" id="ayudaPrincipal">
                ...
                <p class="ayuda-descripcion">Gestione la verificación y entrega de las ordenes de despacho hacia los clientes.</p>
                ...
                <div class="ayuda-grid">
                    <div class="ayuda-columna">
                        ...
                        <ul class="ayuda-lista">
                            ...
                            <li>Código de orden de compra</li>
                            <li>Cliente</li>
                            <li>Estatus</li>
                            <li>Productos</li>
                            <li>Cantidad</li>
            ...
            <div class="ayuda-tarjetas" id="ayudaTarjetas" style="display: none;">
                ...
                <div class="tarjeta-ayuda tarjeta-detallar" data-tarjeta="detallar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite visualizar la información completa de una orden de despacho, incluyendo productos y totales.</p>
                        <ul>
                            <li>Haga clic en el ícono del ojo en la columna "Acciones"</li>
                            <li>Revise la información de la orden y el detalle de productos</li>
                ...
                <div class="tarjeta-ayuda tarjeta-estatus" data-tarjeta="estatus">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite marcar la orden de despacho como entregada de forma inmediata.</p>
                        <ul>
                            <li>Ubique la orden de despacho en la tabla</li>
                ...
                <div class="tarjeta-ayuda tarjeta-reporte" data-tarjeta="reporte">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite descargar la orden de despacho en formato PDF.</p>
                        <ul>
                            <li>Haga clic en el ícono de descarga en la columna "Acciones"</li>
                            <li>Espere a que el sistema genere el PDF</li>
                ...
                <div class="tarjeta-ayuda tarjeta-anular" data-tarjeta="eliminar">
                    ...
                    <div class="tarjeta-contenido">
                        <p>Permite anular una orden de despacho antes de ser entregada.</p>
                        <ul>
                            <li>Encuentre la orden de despacho que desea anular</li>
