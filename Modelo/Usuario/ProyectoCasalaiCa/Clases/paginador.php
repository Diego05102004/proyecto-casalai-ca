    ...
    public function getPiePaginacion($urlBase, $params = []) {
        ...
        if ($this->paginaActual > 1) {
            $html .= '<a href="'.$urlBase.'?pagina='.($this->paginaActual - 1).$queryString.'">
                <i class="flecha-izquierda"><img src="assets/img/flecha_izquierda.svg" alt="Anterior" width="16" height="16"></i>
            </a>';
        }
        $html .= '</td>';
        ...
        if ($this->paginaActual < $this->totalPaginas) {
            $html .= '<a href="'.$urlBase.'?pagina='.($this->paginaActual + 1).$queryString.'">
                <i class="flecha-derecha"><img src="assets/img/flecha_derecha.svg" alt="Siguiente" width="16" height="16"></i>
            </a>';
        }
        $html .= '</td>';
