...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Obtiene la acción enviada en la solicitud POST (si existe)
    $accion = isset($_POST['accion']) ? $_POST['accion'] : '';

    // Ramas controladas por 'accion'
    if ($accion !== '') {
        switch ($accion) {
    ...
    // Ruta específica para obtener los datos de una orden y generar el PDF en el cliente
