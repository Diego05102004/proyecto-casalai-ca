...
final class BitacoraControllerTest extends TestCase
{
    private string $controllerPath;

    protected function setUp(): void
    {
        $this->controllerPath = __DIR__ . '/../../../Controlador/bitacora.php';
    }
...
PHP;
        ...
        $tmpFile = tempnam(sys_get_temp_dir(), 'it_bit_');
        if ($tmpFile === false) {
    ...
    public function testAccionNoValidaBitacora(): void
    {
